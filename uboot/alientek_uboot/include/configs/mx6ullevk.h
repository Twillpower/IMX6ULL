...
#define CONFIG_SYS_INIT_RAM_ADDR	IRAM_BASE_ADDR /* IRAM_BASE_ADDR和IRAM_SIZE在文件arch/arm/include/asm/arch-mx6/imx-regs.h中有定义, 其实就是IMX6UL/IM6ULL内部ocram的首地址和大小 */
